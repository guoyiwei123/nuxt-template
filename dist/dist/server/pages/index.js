...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/index.vue?vue&type=template&id=602b5dba&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('Tutorial')}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/pages/index.vue?vue&type=template&id=602b5dba&

// EXTERNAL MODULE: external "crypto"
var external_crypto_ = __webpack_require__(19);

// CONCATENATED MODULE: ./src/config/url.js
// 接口域名地址
const baseAPIHost = {
  news: {
    test: "http://news-api.pandahelp.vip/v1/slimapi",
    prod: "http://news-api.pandahelp.vip/v1/slimapi"
  }
};
...
const getRealIP = req => {
  return req.headers["cdn-src-ip"] || (req.headers["x-forwarded-for"] ? req.headers["x-forwarded-for"][0] : "") || req.headers["x-real-ip"] || req.socket.remoteAddress;
}; // md5加密

const md5 = value => {
  const hash = Object(external_crypto_["createHash"])("md5");
  hash.update(value);
...
external_axios_default.a.interceptors.response.use(response => response, err => Promise.reject(err)); // get请求
...
// CONCATENATED MODULE: ./src/models/test.js
